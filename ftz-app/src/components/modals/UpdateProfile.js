  ...
  return (
    <div className="grid gap-y-10">
      <form onSubmit={handleSubmit} className="grid gap-y-4">
        ...
        <div>
          <label className="block text-gray-700 text-sm font-medium">Adınız ve Soyadınız</label>
          <div className="mt-1">
            <input
              type="text"
              value={displayName}
      ...
      <form onSubmit={handleResetPassword} className="grid gap-y-4">
        ...
        <div>
          <label className="block text-gray-700 text-sm font-medium">Yeni Parola</label>
          <div className="mt-1">
            <input
              type="password"
              value={password}
